...
from cryptomind.indicator_engine import Indicators
from cryptomind.math_utils import clamp
import logging
...
def compute_scores(
    ...
    log.debug("scores_computed symbol=%s market_score=%.2f confluence=%s", ind.symbol, market_score, confluence_count)
